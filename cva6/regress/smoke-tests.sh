...
cd cva6/sim/
python3 cva6.py --testlist=../tests/testlist_riscv-csr-access-test-cv32a60x.yaml --test PMPCFG0_CSR --iss_yaml cva6.yaml --target cv32a60x --iss=$DV_SIMULATORS $DV_OPTS  --linker=../sim/link.ld
