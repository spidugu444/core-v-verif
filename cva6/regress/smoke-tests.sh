...
cd cva6/sim/
  ...
  python3 cva6.py --target cv32a60x --iss=$DV_SIMULATORS --iss_yaml=cva6.yaml  --asm_test /home/t0268396/Desktop/CHAMSKI_TESTING/core-v-verif/cva6/tests/custom/csr_access_tests/riscv_sstatus_csr_test_0.S $DV_OPTS --linker=/home/t0268396/Desktop/latest/core-v-verif/cva6/sim/link.ld
##  
##  
...
## ython3 cva6.py --testlist=../tests/testlist_riscv-arch-test-cv64a6_imafdc_sv39.yaml --test rv64im-add-01 --iss_yaml cva6.yaml --target cv64a6_imafdc_sv39 --iss=$DV_SIMULATORS $DV_OPTS  --linker=../tests/riscv-isa-sim/arch_test_target/spike/link.ld
